...
Each fundamental check is a short quiz given in class on the day specified. These are quizzes on more rote aspects of the course. You may retake any check as many times as you wish by coming to office hours and asking for a new one (at most one per day). To allow you to drill the skills, I will provide a bank of samples for each check here (with answers included).
