...
### Problem Sets
* [Gradescope instructions](handouts/gsinfo.pdf) for all problem sets. Our course code is **RKEDB2**.
...
* [Problem Set 10](psets/pset10.pdf) (due Friday 5/3 by 10pm)
* [Problem Set 11](psets/pset11.pdf) (for practice only; not to be submitted)
...
* The final exam will be on Friday 5/17, from 9am to noon.
     * You are allowed a **one page notesheet, front and back,** so that you don't need to memorize formulas. Put some time into it -- deciding what to put on the note sheet is a very useful study process!
